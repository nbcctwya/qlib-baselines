...
| `inspect_eval_results.py` | 结果体检：检查单 seed 与 ensemble 输出的行数、NaN/Inf、取值范围和 table==detail 等。 | `python inspect_eval_results.py` |
...
- `AR=exp(mean(g)·252)−1`、`STD=std(g)·√252`、`MDD`（从初始净值 1.0 开始的累计净值最大回撤）、`Sharpe=√252·mean(g)/std(g)`、`Sortino=√252·mean(g)/sqrt(mean(min(g,0)²))`（日度 MAR=0）、`Calmar=AR/abs(MDD)`，`g=log(1+日收益_after_cost)`，`日收益_after_cost = report["return"] − report["cost"]`。
...
- 排序指标 IC/ICIR/RankIC/RankICIR 直接使用 ensemble score 与对齐后的 test label 重新计算。
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| csi300 | XGBoost | 0.0136±0.0007 | 0.0930±0.0045 | 0.0263±0.0008 | 0.1797±0.0042 | 0.076±0.017 | 0.179±0.005 | -0.232±0.023 | **0.410±0.087** | **0.610±0.132** | **0.335±0.103** |
| csi300 | GRU | 0.0152±0.0058 | 0.0855±0.0334 | 0.0358±0.0080 | 0.1958±0.0412 | 0.044±0.040 | 0.162±0.009 | -0.246±0.050 | 0.264±0.237 | 0.395±0.357 | 0.211±0.204 |
| csi300 | TCN | 0.0026±0.0005 | 0.0252±0.0049 | 0.0010±0.0006 | 0.0080±0.0050 | 0.007±0.039 | 0.161±0.003 | -0.244±0.033 | 0.040±0.242 | 0.058±0.348 | 0.043±0.145 |
| csi300 | Transformer | 0.0142±0.0038 | 0.0873±0.0271 | 0.0307±0.0026 | 0.1864±0.0222 | 0.049±0.060 | 0.160±0.011 | -0.260±0.035 | 0.276±0.354 | 0.417±0.533 | 0.212±0.244 |
| sp500 | XGBoost | 0.0028±0.0014 | 0.0308±0.0150 | 0.0040±0.0011 | 0.0443±0.0121 | 0.062±0.026 | 0.177±0.002 | -0.226±0.020 | 0.338±0.139 | 0.480±0.200 | 0.283±0.143 |
| sp500 | GRU | 0.0033±0.0033 | 0.0267±0.0256 | 0.0058±0.0029 | 0.0443±0.0222 | 0.064±0.018 | 0.187±0.034 | -0.229±0.032 | 0.327±0.078 | 0.470±0.115 | 0.278±0.076 |
| sp500 | TCN | -0.0013±0.0010 | -0.0142±0.0107 | -0.0013±0.0007 | -0.0118±0.0063 | 0.007±0.032 | 0.139±0.007 | -0.181±0.014 | 0.049±0.227 | 0.071±0.317 | 0.045±0.178 |
| sp500 | Transformer | 0.0031±0.0017 | 0.0253±0.0134 | 0.0063±0.0016 | 0.0475±0.0110 | 0.013±0.018 | 0.165±0.008 | -0.223±0.016 | 0.074±0.102 | 0.100±0.139 | 0.056±0.076 |

### seed ensemble（raw 平均，`results/tables/ensemble.csv`）

| market | model | IC | ICIR | RankIC | RankICIR | AR | STD | MDD | Sharpe | Sortino | Calmar |
|---|---|---|---|---|---|---|---|---|---|---|---|
| csi300 | XGBoost | 0.0143 | 0.0941 | 0.0276 | 0.1818 | 0.092 | 0.181 | -0.210 | 0.488 | 0.726 | 0.441 |
| csi300 | GRU | 0.0172 | 0.0934 | 0.0396 | 0.2101 | 0.050 | 0.155 | -0.204 | 0.315 | 0.464 | 0.245 |
| csi300 | TCN | 0.0026 | 0.0254 | 0.0012 | 0.0096 | 0.033 | 0.159 | -0.222 | 0.205 | 0.297 | 0.150 |
| csi300 | Transformer | 0.0168 | 0.0962 | 0.0353 | 0.2002 | 0.038 | 0.155 | -0.268 | 0.242 | 0.356 | 0.143 |
| sp500 | XGBoost | 0.0033 | 0.0323 | 0.0049 | 0.0483 | 0.049 | 0.182 | -0.227 | 0.261 | 0.370 | 0.215 |
| sp500 | GRU | 0.0037 | 0.0285 | 0.0064 | 0.0479 | 0.084 | 0.196 | -0.239 | 0.412 | 0.605 | 0.353 |
| sp500 | TCN | -0.0013 | -0.0145 | -0.0014 | -0.0127 | 0.002 | 0.134 | -0.178 | 0.018 | 0.025 | 0.014 |
| sp500 | Transformer | 0.0037 | 0.0282 | 0.0073 | 0.0508 | 0.010 | 0.171 | -0.226 | 0.059 | 0.080 | 0.045 |
